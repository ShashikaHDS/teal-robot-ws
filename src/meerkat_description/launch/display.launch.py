...
def generate_launch_description():
    ...
    lidar2d_launch_file = "/media/meerkat/Meerkat/meerkat_ws/src/sick_scan_xd-develop/launch/sick_tim_5xx.launch.py"

    teleop_launch_file = '/media/meerkat/Meerkat/meerkat_ws/src/meerkat_motors/launch/meerkat_teleop_launch.py'

    odometry_launch_file = '/media/meerkat/Meerkat/meerkat_ws/src/meerkat_odometry/launch/odometry_data_launch.py'
