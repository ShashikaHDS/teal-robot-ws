...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        "map_file",
        default_value=PathJoinSubstitution([FindPackageShare("meerkat_navigation"), "maps", "level6.yaml"]),
        description="/media/meerkat/Meerkat/aryan_ws/src/meerkat_navigation/maps/level6.yaml",
    )
