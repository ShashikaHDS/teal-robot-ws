...
def generate_launch_description():
    ...
    # Static transform publishers for wheel frame compatibility
    static_tf_wheel_left = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_tf_wheel_left',
        arguments=['0', '0', '0', '0', '0', '0', 'drivewhl_l_link', 'wheel_left_link']
    )
    ...
    static_tf_wheel_right = Node(
        ...
        arguments=['0', '0', '0', '0', '0', '0', 'drivewhl_r_link', 'wheel_right_link']
    )
    ...
    return LaunchDescription([
        ...
        # Static transforms for wheel frame compatibility
